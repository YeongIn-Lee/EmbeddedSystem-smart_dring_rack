...
#define US_TRIG_PIN					GPIO_Pin_11		//TIM Ch3 (trig output)

#define US_ECHO_PORT				GPIOA
#define US_ECHO_PIN					GPIO_Pin_8		//TIM Ch1 (echo input)

#define US_TIMER_TRIG_SOURCE		TIM_TS_TI1FP1


#define US_TIMER2					TIM3

#define US_TRIG_PORT2				GPIOB
#define US_TRIG_PIN2					GPIO_Pin_0		//TIM Ch3 (trig output)

#define US_ECHO_PORT2				GPIOA
#define US_ECHO_PIN2					GPIO_Pin_6		//TIM Ch1 (echo input)
/**
